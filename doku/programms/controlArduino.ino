...
#define PIN_velocidad A0  //Pin para la señal de velocidad del tacómetro
#define PIN_posicion A1   //Pin para el potenciómetro de posición
#define PIN_referencia A2 //Pin para el potenciómetro de referencia
// #define PIN_PWM 3         //Pin para la salida de la señal PWM. La frecuencia de PWM 3 y 11 controlada con Timer0 
#define PIN_PWM 13         //Pin para la salida de la señal PWM para poder usar el 2 y el 3 para las interrupciones del encoder
...
// #define PIN_D2 7          //Pin para el bit D2 del encoder. Para el Arduino con Pin 3 averiado 
#define PIN_D3 4          //Pin para el bit D3 del disco de Gray
#define PIN_D4 5          //Pin para el bit D4 del disco de Gray
#define PIN_D5 6          //Pin para el bit D5 del disco de Gray
#define PIN_D6 7          //Pin para el bit D6 del disco de Gray
// #define PIN_D6 12          //Pin para el bit D6 del disco de Gray. Para el Arduino con Pin 3 averiado
#define PIN_D7 8         //Pin para el bit D7 del disco de Gray
#define PIN_D8 9         //Pin para el bit D8 del disco de Gray
#define PIN_D9 10         //Pin para el bit D9 del disco de Gray (índice de vuelta)
...
//    pos=1.8521*pos1-0.8521*pos2+(255/5)*(0.02857*uk[1]+0.02709*uk[2]);
    ...
    velocidad= analogRead(PIN_velocidad);   // Valor entero sin signo 0...1023
  ...
  /* Entradas digitales del Encoder, Gray e Indice de vuelta */
   ...
   bit3=digitalRead(PIN_D3); // Gray
   bit4=digitalRead(PIN_D4);
   bit5=digitalRead(PIN_D5);
   bit6=digitalRead(PIN_D6);
   bit7=digitalRead(PIN_D7);
   bit8=digitalRead(PIN_D8);
   bit9=digitalRead(PIN_D9); // Indice de vuelta
